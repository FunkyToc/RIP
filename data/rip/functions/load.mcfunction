...
scoreboard players reset @a lastDeath
...
execute if score McVersion fktool matches ..11499 run tellraw @a ["",{"text":"[RIP]","bold":true,"color":"gold"},{"text":" Version 1.14 or inferior detected !","color":"red"}]
