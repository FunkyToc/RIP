...
# get dimension
execute if score McVersion fktool matches ..11500 run function rip:set_dimension_1.15
execute if score McVersion fktool matches 11600.. run function rip:set_dimension_1.16